# -*- coding: utf-8 -*-
"""azure_blob_connect.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/11zd4xZ_Beq7fdzzFClQy_NIefrGQEE10
"""
...
# Format: https://storage-acc-name.blob.core.windows.net
account_url_link = "https://somestorageforpractice.blob.core.windows.net"

# Not needed, but lets you see key
...
# Make sure to adjust the 2nd parameter to your container name; that is where the item will be uploaded
upload_blob_file(blob_service_client, 'test-ctnr-for-data', './', 'test.txt')
...
list_blobs_flat(blob_service_client, 'test-ctnr-for-data')